...
<head>
	...
	<title>Доступ к сайту ограничен</title>
	...
	<style type="text/css">
		...
		*:after {
		...
		.brand .logo {
			...
			box-shadow: 0 15px 35px 0 rgba(0,0,0,.13);
			display: flex;
			justify-content: center;
			align-items: center;
			margin-bottom: 30px;
